    ...
    <>
      <section className="relative overflow-hidden px-5 pb-16 pt-36 lg:px-8 lg:pt-44">
        ...
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-sm font-bold uppercase tracking-[0.3em] text-theme-accent">About Us</p>
      ...
      <MotionSection className="px-5 py-16 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-2">
          ...
          <div className="grid gap-6">
            <div className="rounded-[2rem] border border-theme-accent bg-theme-accent-10 p-8">
              <Target className="h-10 w-10 text-theme-accent" aria-hidden="true" />
            ...
            <div className="rounded-[2rem] border border-white/10 bg-white/[0.06] p-8">
              <Users className="h-10 w-10 text-theme-accent" aria-hidden="true" />
      ...
      <MotionSection className="px-5 pb-24 pt-10 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-sm font-bold uppercase tracking-[0.3em] text-theme-accent">Team</p>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {team.map((member) => (
              ...
              >
                <div
                  className="mx-auto flex h-28 w-28 items-center justify-center rounded-full border border-theme-accent/30 bg-slate-950 font-heading text-3xl font-bold text-white"
                  style={{ backgroundImage: 'linear-gradient(to bottom right, rgba(253,195,30,0.4), #0f172a)' }}
                >
