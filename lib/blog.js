...
import { getOptimizedImageSrc } from "./optimized-image-map";
...
export function parseBlogPost(source, filePath = "") {
  ...
  const image = frontmatter.image || "/assets/service-background.png";
  ...
  return {
    ...
    image,
    optimizedImage: getOptimizedImageSrc(image),
