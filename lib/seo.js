...
export const DEFAULT_LAST_MODIFIED = "2026-09-03";
...
export const pageSeo = {
  home: {
    path: "/",
    title: "Custom Software Development Company | KruskalCode",
    description:
      "KruskalCode builds custom software, SaaS platforms, web applications, and business automation systems for growing businesses.",
    image: "/assets/home-banner.png",
    lastModified: DEFAULT_LAST_MODIFIED,
  },
  about: {
    path: "/about/",
    title: "About KruskalCode | Custom Software Development Team",
    description:
      "Learn how KruskalCode engineers custom software, SaaS platforms, and business applications for startups and growing companies.",
    image: "/assets/about_banner.jpg",
    lastModified: DEFAULT_LAST_MODIFIED,
  },
  services: {
    path: "/services/",
    title: "Software Development Services | KruskalCode",
    description:
      "Explore KruskalCode services for custom software, web apps, mobile apps, AI applications, cloud systems, DevOps, and product consulting.",
    image: "/assets/services-banner.jpg",
    lastModified: DEFAULT_LAST_MODIFIED,
  },
  blog: {
    path: "/blog/",
    title: "Software Development Insights | KruskalCode Blog",
    description:
      "Practical articles on custom software, SaaS development, AI automation, cloud strategy, and product engineering for growing businesses.",
    image: "/assets/service-background.png",
    lastModified: DEFAULT_LAST_MODIFIED,
  },
  portfolio: {
    path: "/portfolio/",
    title: "Software Portfolio | KruskalCode Custom Projects",
    description:
      "Browse KruskalCode portfolio work across SaaS platforms, CRM systems, web applications, and custom business software.",
    image: "/assets/choose-us.jpg",
    lastModified: DEFAULT_LAST_MODIFIED,
  },
  contact: {
    path: "/contact/",
    title: "Discuss Your Project | Contact KruskalCode",
    description:
      "Contact KruskalCode to discuss custom software, SaaS platforms, web applications, automation, or AI-powered business systems.",
  ...
  customSoftwareDevelopment: {
    ...
    title: "Custom Software Development Company | KruskalCode",
    description:
      "KruskalCode builds custom software, SaaS platforms, web applications, AI applications, and business automation systems for growing businesses.",
    image: "/assets/home-banner.png",
    lastModified: DEFAULT_LAST_MODIFIED,
  },
  legalTechCaseStudy: {
    path: "/portfolio/legal-technology-saas-platform/",
    title: "Legal Technology SaaS Platform Case Study | KruskalCode",
    description:
      "KruskalCode is engineering the LawWiz legal technology platform — a SaaS product spanning web, mobile, and browser extension surfaces.",
    image: "/assets/optimized/mockups/LawWiz-mockup-1280.webp",
    lastModified: DEFAULT_LAST_MODIFIED,
  },
  docturnalHealth: {
    path: "/portfolio/docturnal-health/",
    title: "Docturnal Health Telemedicine SaaS Case Study | KruskalCode",
    description:
      "KruskalCode implemented Stripe membership plans on Docturnal Health, a US telemedicine SaaS platform built with Laravel, PHP, Bootstrap, and AWS.",
...
export function getOrganizationSchema() {
  return {
    ...
    description:
      "Custom software development company building SaaS platforms, web applications, business automation systems, and production software for growing businesses.",
    email: company.email,
...
export function getSoftwareApplicationSchema() {
  return {
    ...
    name: company.name,
    url: SITE_URL,
    image: absoluteAssetUrl("/assets/home-banner.png"),
    description:
      "Custom software development company building SaaS platforms, web applications, business automation, and enterprise systems for growing businesses.",
...
export function getCustomSoftwareServiceSchema() {
  return {
    "@context": "https://schema.org",
    "@type": "Service",
    ...
    description:
      "KruskalCode builds custom software, SaaS platforms, web applications, AI applications, and business automation systems for growing businesses.",
    url: absoluteUrl(pageSeo.customSoftwareDevelopment.path),
    provider: {
      "@type": "Organization",
      name: company.name,
      url: SITE_URL,
...
export function getSitemapEntries() {
  return [
    pageSeo.home,
    pageSeo.customSoftwareDevelopment,
    pageSeo.about,
    pageSeo.services,
    ...
    pageSeo.portfolio,
    pageSeo.legalTechCaseStudy,
    pageSeo.docturnalHealth,
    pageSeo.contact,
    pageSeo.privacy,
    pageSeo.terms,
  ];
