...
export const blogPostSeo = {
  "ai-automation-trends": {
    title: "AI Automation Trends for Business Teams Guide 2026",
    description:
      "Explore AI automation trends businesses can use to improve operations, customer experience, product workflows, decision-making, and delivery with practical tools.",
  },
  "cloud-strategy-for-modern-teams": {
    title: "Cloud Strategy Guide for Modern Teams and Products",
    description:
      "Learn how a practical cloud strategy improves collaboration, scalability, secure delivery, observability, cost control, and reliability for modern product teams.",
  },
  "building-modern-web-products": {
    title: "Building Modern Web Products with Performance in Mind",
    description:
      "Understand how modern web product teams balance performance, accessibility, frontend architecture, reliability, user experience, and maintainability from the start.",
  },
  "productivity-habits-for-remote-teams": {
    title: "Productivity Habits for Remote Software Teams Guide",
    description:
      "Discover productivity habits for remote software teams, including clearer communication, repeatable process, useful tooling, delivery alignment, and sustainable focus.",
  },
};
...
export function getBlogPostSeo(post) {
  const seo = blogPostSeo[post.slug] || {};
