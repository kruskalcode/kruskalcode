...
export const pageSeo = {
  ...
  customSoftwareDevelopment: {
    ...
    title: "Custom Software Development for Your Business | KruskalCode",
    description:
      "KruskalCode builds custom software, SaaS platforms, enterprise applications, and business automation around the way your business works.",
    image: "/assets/home-banner.png",
    lastModified: DEFAULT_LAST_MODIFIED,
  },
  legalTechCaseStudy: {
    path: "/portfolio/legal-technology-saas-platform/",
    title: "LawWiz Legal Technology SaaS Case Study | KruskalCode",
    description:
      "KruskalCode built LawWiz with a mobile app, web application, browser extensions, and add-ons for legal professionals.",
